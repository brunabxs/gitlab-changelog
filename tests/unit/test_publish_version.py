...
class TestPublishVersion(unittest.TestCase):
    ...
    def test_branch_develop_must_call_generate_version_with_rc(self, mock_get_current_version,
                                                               ...
                                                               mock_git_create_tag, mock_git_push):
    ...
    def test_git_commit_succeeds_must_call_git_create_tag_once(self, mock_get_current_version, mock_generate_version,
                                                               mock_get_version_changes, mock_generate_changelog,
                                                               mock_git_commit, mock_git_create_tag, mock_git_push):
        publish_version('gitlab_endpoint', 'gitlab_token', 'project_id', 'commit_sha', 'branch', 'file')
        mock_git_create_tag.assert_called_once_with('1.2.3-rc.1')
    ...
    def test_git_create_tag_succeeds_must_call_git_push_once(self, mock_get_current_version, mock_generate_version,
                                                             mock_get_version_changes, mock_generate_changelog,
                                                             mock_git_commit, mock_git_create_tag, mock_git_push):
        publish_version('gitlab_endpoint', 'gitlab_token', 'project_id', 'commit_sha', 'branch', 'file')
